...
?>
 <div id="myTabContent" class="tab-content">
    <div role="tabpanel" class="tab-pane fade in active" id="topic" aria-labelledby="home-tab">
        ...
        <?php foreach ($data as $key => $value): ?>
            <div class="tab_box">
                ...
                <div>
                    <a href="/index.php?r=topic%2Fdetail&id=<?php echo $value->id; ?>">
